...
app.use('/api/sects', require('./routes/sect'));
...
app.use('/api/beasts', require('./routes/beasts'));
app.use('/api/blessed-land', require('./routes/blessed-land'));
app.use('/api/bonus', require('./routes/bonus'));
app.use('/api/chat', require('./routes/chat'));
app.use('/api/first-recharge', require('./routes/first-recharge'));
...
app.use('/api/shared-boss', require('./routes/shared-boss'));
app.use('/api/newbie', require('./routes/newbie'));
app.use('/api/immortal-realm', require('./routes/immortal-realm'));
app.use('/api/immortal-quest', require('./routes/immortal-quest'));
