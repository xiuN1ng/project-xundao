...
const MONSTER_AVATARS = {
  ...
  'zombie': null,     // 僵尸
  'demon': null,      // 妖魔
  'dragon': 'assets/flood_dragon.png',     // 蛟龙/洪水龙 (2026-03-22 art-cron生成)
};
...
// ==================== 背景图 ====================
const BACKGROUNDS = {
  'main': 'assets/bg-cultivation-main-20260322.png',       // 主界面修炼场景背景 (2026-03-22 19:35 art-frontend)
  'battle': 'assets/bg-battle-intense-20260322.png', // 战斗副本背景 (2026-03-22 19:37 art-frontend: 激烈战斗场景)
  ...
  'art200019': 'assets/bg-art-20260321-200019.png',                   // AI原画 2026-03-21 20:00 art-cron (78KB 1280x720)
  // 2026-03-22 art-frontend 生成
  'cultivation-main': 'assets/bg-cultivation-main-20260322.png',    // 主界面修炼场景背景 (2026-03-22 19:35)
};

// ==================== 装备套装图标（2026-03-22 art-frontend）====================
const EQUIPMENT_SET_ICONS = {
  'gujian-a': 'assets/equip-gujian-a.png',   // 古剑-A (玉柄金刀)
  'gujian-b': 'assets/equip-gujian-b.png',   // 古剑-B (玄铁长剑)
  'gujia-a': 'assets/equip-gujia-a.png',     // 古甲-A (金鳞战甲)
  'gujia-b': 'assets/equip-gujia-b.png',     // 古甲-B (玄铁头盔)
  'xianpao-a': 'assets/equip-xianpao-a.png', // 仙袍-A (凤凰月纹)
  'xianpao-b': 'assets/equip-xianpao-b.png', // 仙袍-B (星纹黑袍)
  'lingxu-a': 'assets/equip-lingxu-a.png',   // 灵靴-A (云纹灵靴)
  'lingxu-b': 'assets/equip-lingxu-b.png',   // 灵靴-B (风羽靴)
  'hunlian-a': 'assets/equip-hunlian-a.png', // 魂链-A (魂火项链)
  'hunlian-b': 'assets/equip-hunlian-b.png', // 魂链-B (灵蝶吊坠)
  'tianming-a': 'assets/equip-tianming-a.png', // 天命-A (天命金环)
  'tianming-b': 'assets/equip-tianming-b.png', // 天命-B (九星玉镯)
};
...
window.EQUIPMENT_SET_ICONS = EQUIPMENT_SET_ICONS;
...
window.NEW_BACKGROUNDS = {
  ...
  // 2026-03-21 20:00 art-cron 新生成
  'art200019': 'assets/bg-art-20260321-200019.png'                    // AI原画 2026-03-21 20:00 (78KB 1280x720)
};
