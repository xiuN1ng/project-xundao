<template>
  <div class="battle-effect-panel">
    ...
    <div class="panel-content">
      ...
      <div class="effect-section">
        <h3>🌟 特效图鉴</h3>
        <div class="effect-gallery">
          <div class="gallery-item" @click="showEffectDetail('latest')">
            <img 
              :src="latestEffectSrc" 
              alt="最新特效展示"
              class="effect-showcase-img"
            />
            <div class="gallery-label">
              <span class="new-tag">NEW</span>
              <span>仙侠特效 {{ newEffectDate }}</span>
            </div>
          </div>
          <div class="gallery-hint">点击查看大图</div>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      latestEffectSrc: './assets/effect-showcase-20260322-150018.png',
      newEffectDate: '2026-03-22'
    };
  },
  mounted() {
    this.effectId = 0;
  ...
  methods: {
    ...
    showEffectDetail(type) {
      // 触发全屏特效展示
      window.open(this.latestEffectSrc, '_blank');
    }
  }
};
</script>
